...
import { DevicesNewPage, DashboardPage } from './pages'
 ...
 * 6. 分页功能
 */
test.describe('新版设备管理', () => {
  let devicesPage: DevicesNewPage

  test.beforeEach(async ({ authenticatedPage }) => {
    devicesPage = new DevicesNewPage(authenticatedPage)
